(function () {
    ...
    // We get the current value of the Green Gain Dial and assign it to "valueGainDial"
    let valueGainDial = document.getElementById("gainDial").value;

    // Then we assign the "gainLevel" to the current value of the "valueGainDial"
    $(".dial").knob({
        change: function (valueGainDial) {
            gainLevel = valueGainDial;
        }
    });
    ...
    function noteGenerator() {
        ...
        //    It also sets the "RESULT" box at the bottom back to an empty string
        reset();
